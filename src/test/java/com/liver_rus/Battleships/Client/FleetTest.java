...
class FleetTest {
    ...
    @Test
    void addAndRemoveShipsToFleet() throws TryingAddToManyShipsOnFieldException {
    ...
    @Test
    void remove() throws TryingAddToManyShipsOnFieldException {
    ...
    @Test
    void add() throws TryingAddToManyShipsOnFieldException {
        ArrayList<Ship> testShipsList = new ArrayList<>();
        testShipsList.add(Ship.createShip(new FieldCoord(2,3), Ship.Type.AIRCRAFT_CARRIER, true));
        testShipsList.add(Ship.createShip(new FieldCoord(5,5), Ship.Type.SUBMARINE, true));
        testShipsList.add(Ship.createShip(new FieldCoord(4,0), Ship.Type.CRUISER, true));
    ...
    @Test
    void findShip() throws TryingAddToManyShipsOnFieldException {
    ...
    @Test
    void toManyShipsException() throws TryingAddToManyShipsOnFieldException {
        ...
        fleet.add(Ship.createShip(new FieldCoord(2,3), Ship.Type.AIRCRAFT_CARRIER, true));
        fleet.add(Ship.createShip(new FieldCoord(2,3), Ship.Type.AIRCRAFT_CARRIER, true));
        assertThrows(TryingAddToManyShipsOnFieldException.class,
                () -> fleet.add(Ship.createShip(new FieldCoord(2,3), Ship.Type.AIRCRAFT_CARRIER, true)));
    }


    @Test
    void testFormationFleetToTxt() throws TryingAddToManyShipsOnFieldException {
    ...
    @Test
    void testFormationFleetToTxtOtherSequence() throws TryingAddToManyShipsOnFieldException {
