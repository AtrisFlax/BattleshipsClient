...
public class RenderPossibleDeployShip implements DrawGUIEvent {
    private final int x;
    private final int y;
    ...
    public RenderPossibleDeployShip(int x, int y, int shipType, boolean isHorizontal, PlayerType playerType) {
        this.x = x;
        this.y = y;
    ...
    public void render(GraphicsContext gc) {
        ...
        Color color = GUIConstants.POSSIBLE_DEPLOY_COLOR;
